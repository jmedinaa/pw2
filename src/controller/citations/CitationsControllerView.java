...
public class CitationsControllerView extends HttpServlet {
			...
			if(uSearch.isEmpty()){
				...
				if(rSearch.isEmpty()){
					...
					if(aSearch.isEmpty()){
						...
						Key k = KeyFactory.createKey(Citation.class.getSimpleName(), new Long(req.getParameter("id")).longValue());
						Citation citation = pm.getObjectById(Citation.class, k);
						req.setAttribute("citation", citation);
						RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Views/Citations/view.jsp");
