		...
		if(uSearch.isEmpty()){
			...
			if(rSearch.isEmpty()){
				...
				if(aSearch.isEmpty()){
					...
					Key k = KeyFactory.createKey(model.entity.User.class.getSimpleName(), new Long(req.getParameter("id")).longValue());
					model.entity.User user = pm.getObjectById(model.entity.User.class, k);
