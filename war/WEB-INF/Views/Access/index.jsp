	  ...
	  <div class="row content">
	    <div class="col-sm-2 sidenav">
	       <div class="navbar-nav mr-auto  text-left">
				    ...
				    <a class="nav-item nav-link" href="/access/add">New Access</a>
			</div>
	    </div>
	    ...
	    <br>
		  ...
		  <table class="table table-bordered">
		    ...
		    <tbody>
              ...
              <% 
				List<Access> array = (List<Access>)request.getAttribute("access");
			
				if(array.size() > 0) {
					
					for( Access access : array){
		      %>
		      <tr>
		        <td><%=access.getId() %></td>
		        ...
		        <td>
		        <a href="/access/view?id=<%=access.getId()%>">View</a>  
		        <a href="/access/edit?id=<%=access.getId()%>">Edit</a>  
		        <a href="/access/delete?id=<%=access.getId()%>">Delete</a>
		        </td>
		      </tr>
		      	<% } } %>
		    </tbody>
