	  ...
	  <div class="row content">
	    <div class="col-sm-2 sidenav">
	       <div class="navbar-nav mr-auto  text-left">
				    ...
				    <a class="nav-item nav-link" href="/roles/add">New Role</a>
			</div>
	    </div>
		  ...
		  <table class="table table-bordered">
		    ...
		    <tbody>
		      ...
		      <tr>
		        ...
		        <td>
		        <a href="/roles/view?id=<%=rol.getId()%>">View</a>  
		        <a href="/roles/edit?id=<%=rol.getId()%>">Edit</a>  
		        <a href="/roles/delete?id=<%=rol.getId()%>">Delete</a>
		        </td>
		      </tr>
		      	<% } } %>
		    </tbody>
