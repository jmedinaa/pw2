	  ...
	  <div class="row content">
	    <div class="col-sm-2 sidenav">
	       <div class="navbar-nav mr-auto  text-left">
				    ...
				    <a class="nav-item nav-link" href="/roles">List Roles</a>
			</div>
	    </div>
	    ...
	    <br>
		  ...
		  <form method="post"  action="/roles/edit">
		   <div class="form-group">
			   <label>Id:</label>
			   <input type="text"  class="form-control" readonly name="id" value= "<%=role.getId()%>">
		  </div>
		   <div class="form-group">
			    <label>Name:</label>
			    <input type="text" class="form-control" name="name" value= "<%=role.getName()%>" placeholder="Name" required autofocus>
		   </div>
		   <div class="form-group">
			    <label>Status:</label>
