...
<body>
	...
	<div class="container-fluid text-center">    
	  <div class="row content">
	    ...
	    <br>
	      <h3 class="text-primary">New Citation</h3>
		  <form method="post"  action="/citations/add">
		   <div class="form-group">
			    <label>Name:</label>
			    <input type="text" name="name" class="form-control" placeholder="Name"  maxlength="20" required autofocus>
		   </div>
		   <div class="form-group">
			    <label>Type:</label>
		   ...
		   <div class="form-group">
			    <label>Date:</label>
			    <input type="date" class="form-control" name="date" placeholder="Date"  max="2050-05-24" required>
		   </div>
		   <div class="form-group">
